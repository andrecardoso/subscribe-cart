...
describe('Calculator', () => {
  it('should calculate cart', () => {
    const input = `2 book at 12.49
1 music CD at 14.99
1 chocolate bar at 0.85`

    const expected = `2 book: 24.98
1 music CD: 16.49
...
Total: 42.32`
  ...
  it('should calculate cart of imported items', () => {
    const input = `1 imported box of chocolates at 10.00
1 imported bottle of perfume at 47.50`

    const expected = `1 imported box of chocolates: 10.50
...
Total: 65.15`
  ...
  it('should calculate cart of multiple items', () => {
